...
class _ExampleCubeState extends State<ExampleCube> {
  ...
  render() {
    ...
    /*Tutaj wtyczka wykorzystuje swoją funkcje drawArrays która 
      dla 0 wezmie 3 pierwsze wspolrzedne i narysuje trojkat
      dla 1 wezmie wspolrzednie od 1 do 3 i narysuje trojkat
      z tego tych dwoch trojkatow tworzy sie kwadrat po kliknieciu render
    */
    _gl.drawArrays(_gl.TRIANGLES, 0, n);
    _gl.drawArrays(_gl.TRIANGLES, 1, n);
    //_gl.drawArrays(_gl.TRIANGLES, 2, n);
    //_gl.drawArrays(_gl.TRIANGLES, 4, n);
    print(" render n: ${n} ");
    _gl.finish();
